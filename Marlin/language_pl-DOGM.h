...
#define MSG_BED_DONE                        _UxGT("Rozgrzano st贸艂")
...
#define MSG_FILAMENT_CHANGE_HEADER          _UxGT("ZMIE艃 FILAMENT")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("ZMIE艃 OPCJE:")
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ekstruduj wi臋cej")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Wzn贸w drukowanie")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("ekstruzj臋 filamentu")
