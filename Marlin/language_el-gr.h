...
#define MSG_RESUMING                        _UxGT("危蠀谓蔚蠂委味蔚蟿伪喂 畏 蔚魏蟿蠉蟺蠅蟽畏")
...
#define MSG_HEATING_COMPLETE                _UxGT("螚 胃苇蟻渭伪谓蟽畏 慰位慰魏位畏蟻蠋胃畏魏蔚.")
#define MSG_BED_HEATING                     _UxGT("螛苇蟻渭伪谓蟽畏 魏位委谓畏蟼.")
#define MSG_BED_DONE                        _UxGT("螚 魏位委谓畏 慰位慰魏位畏蟻蠋胃畏魏蔚.")
