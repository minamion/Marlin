...
#define MSG_SET_HOME_OFFSETS                _UxGT("Regl. d茅cal. origine")
...
#define MSG_SWITCH_PS_OFF                   _UxGT("脡teindre alim.")
#define MSG_EXTRUDE                         _UxGT("脡xtrusion")
#define MSG_RETRACT                         _UxGT("R茅traction")
#define MSG_MOVE_AXIS                       _UxGT("D茅placer un axe")
#define MSG_BED_LEVELING                    _UxGT("R猫gl. Niv. lit")
#define MSG_LEVEL_BED                       _UxGT("R猫gl. Niv. lit")
#define MSG_EDITING_STOPPED                 _UxGT("Arr锚t edit. maillage")
...
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("Offset Z arr锚t茅")
...
#define MSG_CONTROL_RETRACTF                _UxGT("R茅traction V")
...
#define MSG_AUTORETRACT                     _UxGT("R茅tract. Auto.")
#define MSG_FILAMENTCHANGE                  _UxGT("Changer filament")
#define MSG_INIT_SDCARD                     _UxGT("Init. la carte SD")
#define MSG_CNG_SDCARD                      _UxGT("Changer de carte")
#define MSG_ZPROBE_OUT                      _UxGT("Z sonde ext猫. lit")
...
#define MSG_HEATING_COMPLETE                _UxGT("Chauffe termin茅e")
#define MSG_BED_HEATING                     _UxGT("Lit en chauffe..")
#define MSG_BED_DONE                        _UxGT("Chauffe lit termin茅e")
